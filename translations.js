...
function initializePageContent()
{
	...
	var translations =
	{
		...
		'en':
		{
			...
			'str-content-downloadlink-3': 'Edition with KDE Plasma desktop environment, its software suite changes to adapt to Qt, by <a class="element" href="https://github.com/gatoverde95">Gatoverde95</a>.',
			'str-content-downloadlink-4': 'CuerdOS + Cinnamon, an edition that aims to be easy to use and friendly for all types of users, by <a class="element" href="https://github.com/gatoverde95">Gatoverde95</a>.',
		...
		'es':
		{
			...
			'str-content-downloadlink-3': 'Edición con el entorno de escritorio KDE Plasma, su suit de software cambia para adaptarse a Qt, por <a class="element" href="https://github.com/gatoverde95">Gatoverde95</a>.',
			'str-content-downloadlink-4': 'CuerdOS + Cinnamon, una edición que busca ser sencilla de usar y amigable para todo tipo de usuarios, por <a class="element" href="https://github.com/gatoverde95">Gatoverde95</a>.',
