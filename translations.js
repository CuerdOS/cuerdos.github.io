var translations =
	{
		...
		'en':
		{
			...
			'str-content-otherfeatures-9': 'Select-install installer (kernel selection and Standard iso window manager).',
			...
			'str-subtitle-nhsabout': 'The NHS images have been replaced by the "select install", in which you can choose between LTS or NHS (Stable) kernel.',
		...
		'es':
		{
			...
			'str-title-otherfeatures': 'Otras características técnicas',
    			...
    			'str-content-otherfeatures-9': 'Instalador select-install (selección de kernel y gestor de ventana iso Standard).',
			...
			'str-subtitle-nhsabout': 'Las imágenes NHS han sido sustituidas por el "select install", en el que se puedes elegir entre kernel LTS o NHS (Estable).',
		...
		'pt':
		{
			...
			'str-title-otherfeatures': 'Outras características técnicas',
    			...
    			'str-content-otherfeatures-9': 'Instalador select-install (seleção de kernel e gerenciador de janela iso Standard).',
			...
			'str-subtitle-nhsabout': 'As imagens NHS foram substituídas pela "instalação selecionada", na qual você pode escolher entre LTS ou NHS (Stable).',
