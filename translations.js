var translations =
	{
		...
		'en':
		{
			...
			'str-content-downloadlink-1': 'This is the edition with the default CuerdOS environment that has the Sway window manager.',
		...
		'es':
		{
			...
			'str-title-downloadlink-2': 'CuerdOS Legacy',
			'str-content-downloadlink-2': 'Originalmente, CuerdOS estaba planeado solo como Xfce, una idea inicialmente descartada pero ahora revivida como una edición dedicada.',			'str-subtitle-upgradewarning': '*Antes de probar el sistema, recomendamos encarecidamente que actualice a la última versión, ya que tendrá todas las nuevas características y errores corregidos.*',
		...
		'pt':
		{
			...
			'str-content-downloadlink-1': 'Essa é a edição com o ambiente padrão do CuerdOS que tem o gerenciador de janelas Sway.',
