var translations =
	{
		...
		'en':
		{
			...
			'str-spins-title': 'Variations of CuerdOS',
			'str-spins-desc': 'Here you will find a series of CuerdOS Spins with other desktop environments, which are created by the community.',
		...
		'es':
		{
			...
			'str-spins-title': 'Variaciones de CuerdOS',
			'str-spins-desc': 'Aquí encontraras una serie de Spins de CuerdOS con otros entornos de escritorio, los cuales son creados por la comunidad.',
		...
		'pt':
		{
			...
			'str-spins-title': 'Variações do CuerdOS',
			'str-spins-desc': 'Aqui você encontrará uma série de CuerdOS Spins com outros ambientes de trabalho, criados pela comunidade.',
