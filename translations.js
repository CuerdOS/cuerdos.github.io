...
function initializePageContent()
{
	...
	var translations =
	{
		...
		'en':
		{
			...
			'str-content-downloadlinknhs-1': '"New Hardware Support" image',
			...
			'str-content-downloadlinknhs-2': '"New Hardware Support" image',
		...
		'es':
		{
			...
			'str-content-downloadlinknhs-1': 'Imagen "New Hardware Support"',
			'str-title-downloadlink-2': 'CuerdOS Legacy',
			...
			'str-content-downloadlinknhs-2': 'Imagen "New Hardware Support"',
