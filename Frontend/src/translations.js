const translations = {
  //ENGLISH STRINGS
    ...
    "str-content-otherfeatures-1": "Bauh Store preconfigured for easy installation of software (Debs and Flatpak).",
    ...
    "str-changelog-news-changes-2.0-main-news-1" : "Migration to the new base: ",
    ...
    "str-changelog-news-changes-2.0-deprecated-news-2-2": "Budgie and X3",
      //New Features
  ...
  es: {
    ...
    "str-changelog-news-changes-2.0-r": "Migración a una nueva base principal y más novedades",
      //Core
    "str-changelog-news-changes-2.0-main-news-title": "Core Changes",
    "str-changelog-news-changes-2.0-main-news-1" : "Migración a una nueva base principal: ",
    ...
    "str-changelog-news-changes-2.0-main-news-3": " como frontend por defecto para APT",
    ...
    "str-changelog-news-changes-2.0-deprecated-news-2-2": "Budgie y X3",
      //New Features
    "str-changelog-news-changes-2.0-newsFeatures-title": "Nuevas Mejoras",
    "str-changelog-news-changes-2.0-newsFeatures-2-1": "Incorporación de nuevos entornos:", 
    "str-changelog-news-changes-2.0-newsFeatures-2-2" : "Sway y kde",
