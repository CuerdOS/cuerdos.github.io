const translations = {
  //ENGLISH STRINGS
    ...
    "str-content-otherfeatures-3": "CuerdToken as a new update assistant for CuerdOS.",
    ...
    "str-tablecontent-recracm": "3GB of RAM",
    ...
    "str-tablecontent-recram": "3GB of RAM",
    ...
    "str-download-other": "More Downloads",
    "str-spins-title": "CuerdOS Flavours",
    "str-spins-description": "Explore and enjoy the experience of our flavours.",
    // FooterComponent
    "str-subtitle-logolicense-1": 'The ',
    "str-subtitle-logolicense-2": 'CuerdOS Logo',
    "str-subtitle-logolicense-3": 'is published under the license.',
    ...
    "str-changelog-description": "Track the evolution of CuerdOS through our detailed changelog and known issues",
          //v2.1
    "str-changelog-news-changes-2.1-r": "Quality of Life and General changes.",
      //Core
    "str-changelog-news-changes-2.1-main-news-title": "Changes:",
    "str-changelog-news-changes-2.1-main-news" : "New CuerdOS repository, hosted by us.",
    "str-changelog-news-changes-2.1-main-news-1" : "UFW enabled by default.",
    "str-changelog-news-changes-2.1-main-news-2": "CuerdTools updated  with some performance and new functions.",
    "str-changelog-news-changes-2.1-main-news-3": "Catalog reductions to prioritize quality, sostenibility and beter support of the proyect.",
    "str-changelog-news-changes-2.1-main-kernel-1" : "Kernel updated to 6.18.9 version.",
    "str-changelog-news-changes-2.1-main-kernel-2": "Better cpu overhead management and network buffer control..",
    "str-changelog-news-changes-2.1-main-changes-1": "Rollback to X11 due to XLibre issues with Nvidia GPU's and services like VNC or RDP.",
    "str-changelog-news-changes-2.1-main-desktops-kde-1": "Removed X11 session from KDE.",
    "str-changelog-news-changes-2.1-main-desktops-kde-2": "Cleanse of redundant programs on KDE.",
    "str-changelog-news-changes-2.1-main-desktops-kde-3": "Olive accent colour defined on KDE by default to follow website cosmetics.",
    "str-changelog-news-changes-2.1-main-desktops-kde-4": "Onlyoffice as default on KDE.",
    "str-changelog-news-changes-2.1-main-desktops-kde-5":"New custom splash on KDE.",
    "str-changelog-news-changes-2.1-main-desktops-kde-6":"Optimized KWin to not create issues with Vivaldi.",
    "str-changelog-news-changes-2.1-main-desktops-kde-7":"Replacing non-KDE programs with those included in the KDE Suite.",
    "str-changelog-news-changes-2.1-main-desktops-xfce-1":"XFWM4 compositor replaced by Fastcompmgr.",
    ...
    "str-changelog-news-changes-2.1-main-cuerdtools-3":"CuedTools now run natively in Wayland but in X11 runs with WX to emulate X11 calls.",
    "str-changelog-news-changes-2.1-main-cuerdtools-4":"Solved 124 vulnerabilities on CuerdTools.",
      //Deprecated
    "str-changelog-news-changes-2.1-deprecated-news-title": "Desechados",
    "str-changelog-news-changes-2.1-deprecated-news-2-1": "Isos desechadas: ",
    "str-changelog-news-changes-2.1-deprecated-news-2-2": "Budgie. Cinnamon, LXQt, Mate",
      //v2.0
  ...
  es: {
    ...
    "str-content-otherfeatures-1": "Yelena Store preconfigurado para facilitar la instalación de programas.",
    "str-content-otherfeatures-2": "ZRam preconfigurado con apenas impacto en el uso de la CPU.",
    "str-content-otherfeatures-3": "CuerdToken el nuevo asistente de actualizaciones de CuerdOS.",
    ...
    "str-tablecontent-minram": "2GB de RAM",
    "str-tablecontent-recracm": "3GB de RAM",
    ...
    "str-download-other": "Otras Fuentes",
    ...
    "str-subtitle-logolicense-1": 'El ',
    "str-subtitle-logolicense-2": 'Logo de CuerdOS ',
    "str-subtitle-logolicense-3": 'está publicado bajo licencia',
    ...
    "str-tablecontent-recram": "3GB de RAM",
    "str-changelog-nav": "Changelog",
    ...
    "str-changelog-description": "Sigue la evolución de CuerdOS a través de nuestro changelog detallado y conoce problemas encontrados",
          //v2.1
    "str-changelog-news-changes-2.1-r": "Cambios generales y actualizaciones de calidad de vida.",
      //Core
    "str-changelog-news-changes-2.1-main-news-title": "Cambios:",
    "str-changelog-news-changes-2.1-main-news" : "Nuevo repositorio de CuerdOS, ahora hosteado por nosotros.",
    "str-changelog-news-changes-2.1-main-news-1" : "UFW activado por defecto.",
    "str-changelog-news-changes-2.1-main-news-2": "Actualización de las CuerdTools, incluyen mejoras de rendimiento y funciones nuevas.",
    "str-changelog-news-changes-2.1-main-news-3": "Reducción del catálogo de ediciones para priorizar la calidad, sostenibilidad y soporte del proyecto.",
    "str-changelog-news-changes-2.1-main-kernel-1" : "Actualización del kernel a la versión 6.18.9.",
    "str-changelog-news-changes-2.1-main-kernel-2": "Mejor gestión del overhead de la CPU y control de buffer de red.",
    "str-changelog-news-changes-2.1-main-changes-1": "Rollback a X11 debido a problemas con XLibre en tarjetas gráficas Nvidia y problemas con servicios como VNC o RDP.",
    "str-changelog-news-changes-2.1-main-desktops-kde-1": "Sesión X11 suprimida en KDE.",
    "str-changelog-news-changes-2.1-main-desktops-kde-2": "Limpieza de programas redundantes en KDE.",
    "str-changelog-news-changes-2.1-main-desktops-kde-3": "Color de acento Oliva establecido en KDE por defecto para seguir la estética de la web.",
    "str-changelog-news-changes-2.1-main-desktops-kde-4": "Onlyoffice como suite ofimática por defecto en KDE.",
    "str-changelog-news-changes-2.1-main-desktops-kde-5":"Nuevo splash personalizado para la iso KDE.",
    "str-changelog-news-changes-2.1-main-desktops-kde-6":"KWin optimizado para no causar problemas con Vivaldi.",
    "str-changelog-news-changes-2.1-main-desktops-kde-7":"Sustitución de programas ajenos a KDE por unos propios de la suite de KDE.",
    "str-changelog-news-changes-2.1-main-desktops-xfce-1":"Cambio del compositor de xfwm4 por Fastcompmgr.",
    "str-changelog-news-changes-2.1-main-desktops-sway-1":"SnapWay preinstalado para capturar la pantalla en Sway..",
    "str-changelog-news-changes-2.1-main-desktops-sway-2":"Swaylock-fancy sustituido por GtkLock.",
    "str-changelog-news-changes-2.1-main-desktops-sway-3":"SwayOSD preinstalado en Sway.",
    "str-changelog-news-changes-2.1-main-desktops-sway-4":"Cambios estéticos en waybar para un toque más moderno.",
    "str-changelog-news-changes-2.1-main-desktops-labwc-1":"LabWC sustituye LXQt",
    "str-changelog-news-changes-2.1-main-cuerdtools-1":"Cambio de CuerdTool, K-Hello sustituye a Yelena Hello.",
    "str-changelog-news-changes-2.1-main-cuerdtools-2":"Wasabi reemplaza a Celluloid y Haruna por otro reproductor multimedia.",
    "str-changelog-news-changes-2.1-main-cuerdtools-3":"Todas las CuerdTools se ejecutan nativamente en Wayland y en X11 corre mediante emulación con WX.",
    "str-changelog-news-changes-2.1-main-cuerdtools-4":"Se solucionaron 124 vulnerabilidades en las CuerdTools.",
      //Deprecated
    "str-changelog-news-changes-2.1-deprecated-news-title": "Desechados",
    "str-changelog-news-changes-2.1-deprecated-news-2-1": "Isos desechadas: ",
    "str-changelog-news-changes-2.1-deprecated-news-2-2": "Budgie. Cinnamon, LXQt, Mate",
