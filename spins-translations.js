var translations =
	...
	'str-content-spins-1': 'CuerdOS Visuals are variations of the distro with alternative desktop environments to the original project and a selection of applications of their own, thus offering different ways to experience CuerdOS. These projects are developed by members of the community.',
			...
			'str-content-downloadlink-6': 'Edition with LXQt desktop environment, with an original and more familiar customization.',
			'str-content-downloadlink-7': 'Edition with the Mate desktop environment, with a customization inspired by the ElementaryOS Pantheon desktop.',
			'str-content-downloadlink-8': 'Edition with Budgie desktop environment, with an original and more familiar customization.',
			'str-content-downloadlink-9': 'An experimental image of CuerdOS that mounts the Xfce desktop and the I3 window manager, providing an experience with the comfort of a desktop environment and the fluidity of a tiling window manager',
			'str-desc-autor': 'These editions were created and are mainly maintained by <a class="element" href="https://github.com/gatoverde95">Gatoverde95</a>.',
	...
	'str-content-spins-1': 'Os CuerdOS Visuals são variações da distribuição com ambientes de área de trabalho alternativos ao projeto original e uma seleção de aplicativos próprios, oferecendo assim diferentes maneiras de experimentar o CuerdOS. Esses projetos são desenvolvidos por membros da comunidade.',
			...
			'str-content-downloadlink-6': 'Edição com ambiente de desktop LXQt, com uma personalização original e mais familiar',
			'str-content-downloadlink-7': 'Edição com o ambiente de trabalho Mate, com uma personalização inspirada no ambiente de trabalho Pantheon do ElementaryOS',
			'str-content-downloadlink-8': 'Edição com o ambiente de desktop Budgie, com uma personalização original e mais familiar',
			'str-content-downloadlink-9': 'Uma imagem experimental do CuerdOS que monta a área de trabalho do Xfce e o gerenciador de janelas I3, proporcionando uma experiência com o conforto de um ambiente de área de trabalho e a fluidez de um gerenciador de janelas em mosaico',
			'str-desc-autor': 'Estas edições foram criadas e são mantidas principalmente por  <a class="element" href="https://github.com/gatoverde95">Gatoverde95</a>.',
